  ...
  return (
    <section className='flex justify-wrap items-center max-lg:flex-col-reverse gap-10 max-container'>
      ...
      <div className="flex flex-1 flex-col">
        <h2 className='capitalize lag:max-w-lg font-palanquin text-4xl font-bold'>
          <span className='text-coral-red'> Special </span>Offer
        </h2>
        <p className='mt-4 lg:max-w-lg info-text'>
          Embark on a shopping journey that redefines your experience with unbeatable deals. 
          From premier selections to incredible savings, we offer unparalled value that stes us apart.
        </p>
        <p className='my-6 lg:max-w-lg info-text'>
          Navigate a realm of possibilities designed to fulfill yoir unique desires, surpassing 
